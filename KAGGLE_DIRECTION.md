...
ある姿勢を取っている人物のbboxと関節点の推定結果が与えられた時に、その人物が立っているか座っているかを判定する関数を作成してください。
だし、入力画像の人物は必ず立っているか座っているかどちらかの姿勢を取るものとします。
...
'''
評価指標はMacro F1としてください。
/datasets/output_jsons_sittingには、入力形式に従ったsittingのデータが、/datasets/output_jsons_standingには、入力形式に従ったstandingのデータがそれぞれ格納されています。
---
